...
package com.zizaike.open.entity.taobao.request;  
...
import com.zizaike.open.entity.XStreamYMDDateConverter;
import com.zizaike.open.entity.XStreamYMDHMSDateConverter;
...
public class BookRQRequest extends RequestData {
	...
	@XStreamConverter(value=XStreamYMDHMSDateConverter.class)
	private Timestamp earliestArriveTime;
	/*
	 * 最晚到店时间
	 */
	@XStreamAlias("LatestArriveTime")
	@XStreamConverter(value=XStreamYMDHMSDateConverter.class)
	private Timestamp latestArriveTime;
	/*
	 * 房间数量（最大为9）
	 */
	...
	public Timestamp getEarliestArriveTime() {
		return earliestArriveTime;
	}
	public void setEarliestArriveTime(Timestamp earliestArriveTime) {
		this.earliestArriveTime = earliestArriveTime;
	}
	public Timestamp getLatestArriveTime() {
		return latestArriveTime;
	}
	public void setLatestArriveTime(Timestamp latestArriveTime) {
	...
	public String getDailyInfos() {
		return dailyInfos;
	}
	public void setDailyInfos(String dailyInfos) {
	...
	public long getOrderGuests() {
		return orderGuests;
	}
	public void setOrderGuests(long orderGuests) {
	...
	public void setReceiptInfo(Object receiptInfo) {
	...
	public BookRQRequest(AuthenticationToken authenticationToken, long taoBaoOrderId, long taoBaoHotelId,
			...
			long taoBaoGid, Timestamp checkIn, Timestamp checkOut, String hourRent, Timestamp earliestArriveTime,
			Timestamp latestArriveTime, int roomNum, long totalPrice, long sellerDiscount, long alitripDiscount,
			String currency, int paymentType, String contactName, String contactTel, String contactEmail,
			String dailyInfos, String day, long price, long orderGuests, String name, int roomPos, String comment,
			String memberCardNo, String guaranteeType, Object receiptInfo, String receiptTitle, String receiptType,
			String receiptAddress, String extensions) {
		super();
		this.authenticationToken = authenticationToken;
		this.taoBaoOrderId = taoBaoOrderId;
		this.taoBaoHotelId = taoBaoHotelId;
	...
	public String toString() {
		return "BookRQRequest [authenticationToken=" + authenticationToken + ", taoBaoOrderId=" + taoBaoOrderId
				...
				+ contactEmail + ", dailyInfos=" + dailyInfos + ", day=" + day + ", price=" + price + ", orderGuests="
				+ orderGuests + ", name=" + name + ", roomPos=" + roomPos + ", comment=" + comment + ", memberCardNo="
				+ memberCardNo + ", guaranteeType=" + guaranteeType + ", receiptInfo=" + receiptInfo + ", receiptTitle="
				+ receiptTitle + ", receiptType=" + receiptType + ", receiptAddress=" + receiptAddress + ", extensions="
				+ extensions + "]";
	}

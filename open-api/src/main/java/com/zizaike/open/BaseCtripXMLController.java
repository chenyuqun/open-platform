...
import com.zizaike.entity.open.ctrip.response.ResponseExceptionData;
 ...
 * @since JDK 1.7
 */
public abstract class BaseCtripXMLController {
    ...
    public String jsonpBuilder( ResponseData resultBean) {
            return XstreamUtil.getCtripResponseXml(resultBean);
    }

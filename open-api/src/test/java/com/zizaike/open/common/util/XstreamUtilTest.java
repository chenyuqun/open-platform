...
public class XstreamUtilTest extends BaseTest {
    ...
    public void getXml2BeanBookRQRequest() throws ZZKServiceException {
        String xml = "<BookRQ>"+"<AuthenticationToken>"+"<Username>taobao</Username>"
        		+"<Password>taobao</Password>"+"<CreateToken>taobao1387784033263-1387784033266</CreateToken>"
        		+"</AuthenticationToken>"+"<TaoBaoOrderId>1387784033263</TaoBaoOrderId>"+"<TaoBaoHotelId>123456789</TaoBaoHotelId>"
        		+"<HotelId>80</HotelId>"+"<TaoBaoRoomTypeId>123456978</TaoBaoRoomTypeId>"+"<RoomTypeId>ST</RoomTypeId>"
        		+"<TaoBaoRatePlanId >123000123</TaoBaoRatePlanId >"+"<RatePlanCode>VIP</RatePlanCode>"
        		+"<TaoBaoGid>1234567890</TaoBaoGid>"+"<CheckIn>2013-12-24 00:00:00</CheckIn>"+"<CheckOut>2013-12-26 00:00:00</CheckOut>"
        		+"<HourRent>false</HourRent>"+"<EarliestArriveTime>2013-12-24 20:00:00</EarliestArriveTime>"
        		+"<LatestArriveTime>2013-12-24 22:00:00</LatestArriveTime>"+"<RoomNum>1</RoomNum>"+"<TotalPrice>63850</TotalPrice>"
        		+"<SellerDiscount>6800</SellerDiscount >"+"< AlitripDiscount >800</ AlitripDiscount >"+"<Currency>CNY</Currency>"
        		+"<PaymentType>5</PaymentType>"+"<ContactName>测试联系人</ContactName>"+"<ContactTel>13920682209</ContactTel>"
        		+"<ContactEmail >hello@taobao.com</ ContactEmail >"+"<DailyInfos>"+"<DailyInfo>"+"<Day>2013-12-24</Day>"
        		+"<Price>17800</Price>"+"</DailyInfo>"+"<DailyInfo>"+"<Day>2013-12-25</Day>"+"<Price>46050</Price>"
        		+"</DailyInfo>"+"</DailyInfos>"+"<OrderGuests>"+"<OrderGuest>"+"<Name>入住人1</Name>"+"<RoomPos>1</RoomPos>"
        		+"</OrderGuest>"+"<OrderGuest>"+"<Name>入住人2</Name>"+"<RoomPos>1</RoomPos>"+"</OrderGuest>"+"</OrderGuests>"
        		+"<Comment>测试</Comment>"+"<GuaranteeType> 0</GuaranteeType>"+"<MemberCardNo >NB888888888</ MemberCardNo>"
        		+"<ReceiptInfo>"+"<ReceiptTitle>淘宝软件有限公司</ReceiptTitle>"+"<ReceiptType>房费</ReceiptType>"+"<ReceiptAddress>{\"name\":\"收件人\",\"address\":\"北京市\",\"postCode\":\"100022\",\"mobile\":\"13877779999\",\"phone\":\"01082828989\"}</ReceiptAddress>"
        		+"</ ReceiptInfo>"+"<Extensions></Extensions>";

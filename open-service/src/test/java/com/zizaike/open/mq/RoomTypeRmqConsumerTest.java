...
public class RoomTypeRmqConsumerTest extends BaseTest {
    ...
    @Test(description = "rabbitmq roomType addRoomType 测试")
    public void addRoomType() throws ZZKServiceException, InterruptedException, ApiException {
    ...
    @Test(description = "rabbitmq roomType updateRoomType 测试")
    public void updateRoomType() throws ZZKServiceException, InterruptedException, ApiException {
        RoomType roomType = new RoomType();
        roomType.setAction(Action.UPDATE);
        roomType.setOuterId("534_123");
        //req.setHid((long)123456);
        roomType.setName("阮佳佳的别墅");
        roomType.setMaxOccupancy(2L);
